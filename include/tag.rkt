...
(define-libgit2/check git_tag_annotation_create
  (_fun _git_oid-pointer _repository _string _object _signature _string -> _int))

(define-libgit2/check git_tag_create
  (_fun _git_oid-pointer _repository _string _object _signature _string _bool -> _int))

(define-libgit2/check git_tag_create_frombuffer
  (_fun _git_oid-pointer _repository _string _bool -> _int))

(define-libgit2/check git_tag_create_lightweight
  (_fun _git_oid-pointer _repository _string _object _bool -> _int))
...
(define-libgit2/alloc git_tag_lookup
  (_fun _tag _repository _git_oid-pointer -> _int)
  git_tag_free)

(define-libgit2/alloc git_tag_lookup_prefix
  (_fun _tag _repository _git_oid-pointer _size -> _int)
  git_tag_free)
