...
(define-libgit2/alloc git_patch_from_blobs
  (_fun _patch _blob _string _blob _string _git_diff_opts-pointer -> _int))
(define-libgit2/alloc git_patch_from_blob_and_buffer
  (_fun _patch _blob _string _string _size _string _git_diff_opts-pointer -> _int))
(define-libgit2/alloc git_patch_from_buffers
  (_fun _patch (_cpointer _void) _size _string _string _size _string _git_diff_opts-pointer -> _int))
